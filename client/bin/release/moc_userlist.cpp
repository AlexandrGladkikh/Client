...
#include "../../client/including/userlist.h"
...
QT_MOC_LITERAL(3, 23, 4)
    ...
    "UserList\0SelectedName\0\0name"
};
...
void UserList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->SelectedName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (UserList::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UserList::SelectedName)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UserList::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_UserList.data,
...
// SIGNAL 0
void UserList::SelectedName(QString _t1)
{
