...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        userList = new UserList(centralWidget);
        ...
        browserMsg = new QTextBrowser(centralWidget);
        ...
        choiceSmile = new QPushButton(centralWidget);
        ...
        labelPrivate = new QLabel(centralWidget);
        ...
        msgEdit = new TextEdit(centralWidget);
